...
function setup() {
	...
	redboxbody1 = Bodies.rectangle(400,650,200,20,{isStatic:true});
	World.add(world,redboxbody1);
	
	redboxbody2 = Bodies.rectangle(310,600,20,100,{isStatic:true});
	World.add(world,redboxbody2);
	
	redboxbody3= Bodies.rectangle(490,600,20,100,{isStatic:true});
	World.add(world,redboxbody3);
